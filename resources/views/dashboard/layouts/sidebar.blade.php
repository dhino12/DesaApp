        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ Request::is('dashboard') ? 'active' : '' }}">
                ...
                <ul class="sidebar-submenu">
                    <li>
                        <a href="/dashboard" class="{{ Request::is('dashboard') ? 'active' : '' }}">Analytics Dashboard</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="banking-dashboard.html">Banking Dashboard</a>
                    </li>
                </ul>
            </li>
            
            <li class="sidebar-menu-title">Form</li>
            <li class="{{ Request::is('dashboard/form-indikator-desa*') ? 'active' : '' }}">
                <a href="/dashboard/form-indikator-desa" class="navItem">
                    <span class="flex items-center">
                        <iconify-icon class="nav-icon" icon="heroicons:presentation-chart-line"></iconify-icon>
                        <span>Indikator Pengelolaan Desa</span>
                    </span>
                </a>
            </li>
            <!-- Apps Area -->
            ...
            <li class="{{ Request::is('dashboard/email*') ? 'active' : '' }}">
            ...
            <li class="{{ Request::is('dashboard/kanban*') ? 'active' : '' }}">
            ...
            <li class="{{ Request::is('dashboard/todo*') ? 'active' : '' }}">
