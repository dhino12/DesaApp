        ...
        <div class="flex sm:space-x-4 space-x-2 sm:justify-end items-center rtl:space-x-reverse">
            <button
                ...
                <span class="flex items-center">
                    <iconify-icon class="text-xl ltr:mr-2 rtl:ml-2 font-light" icon="heroicons-outline:calendar">
                    </iconify-icon>
                    <span>Weekly</span>
                </span>
            </button>
            <button
                class="btn inline-flex justify-center bg-white text-slate-700 dark:bg-slate-700 !font-normal dark:text-white ">
                <span class="flex items-center">
                    <iconify-icon class="text-xl ltr:mr-2 rtl:ml-2 font-light" icon="heroicons-outline:filter">
                    </iconify-icon>
    ...
    <div class="grid grid-cols-12 gap-5 mb-5">
        <div class="2xl:col-span-3 lg:col-span-4 col-span-12">
            <div class="bg-no-repeat bg-cover bg-center p-5 rounded-[6px] relative"
                style="background-image: url(/images/all-img/widget-bg-2.png)">
                ...
                <div class="card-body p-6">
                    ...
                    <div class="pb-2">
                        <div class="grid md:grid-cols-3 grid-cols-1 gap-5">
                            <div class="relative z-[1] text-center p-4 rounded before:w-full before:h-[calc(100%-60px)] before:absolute before:left-0 before:top-[60px] before:rounded before:z-[-1] before:bg-opacity-[0.1] before:bg-info-500">
                            ...
                            <div class="relative z-[1] text-center p-4 rounded before:w-full before:h-[calc(100%-60px)] before:absolute before:left-0 before:top-[60px] before:rounded before:z-[-1] before:bg-opacity-[0.1] before:bg-warning-500">
                                <div
                            ...
                            <div class="relative z-[1] text-center p-4 rounded before:w-full before:h-[calc(100%-60px)] before:absolute before:left-0 before:top-[60px] before:rounded before:z-[-1] before:bg-opacity-[0.1] before:bg-success-500">
                                <div class="  h-[70px] w-[70px] rounded-full mx-auto mb-4 relative">
                        ...
                        <div class="grid grid-cols-1 gap-5 mt-5">
                            <div class="relative z-[1] p-4 rounded md:flex items-center bg-gray-5003 dark:bg-slate-900 md:space-x-10 md:space-y-0 space-y-3 rtl:space-x-reverse">
                ...
                <div class="card-body p-6">
                    ...
                    <div class="grid md:grid-cols-3 grid-cols-1 gap-5">
                        <div class="bg-slate-50 dark:bg-slate-900 p-4 rounded text-center">
                            ...
                            <span
                                class="text-slate-500 dark:text-slate-300 text-sm mb-1 block font-normal">$150.00</span>
                            <span class="text-slate-600 dark:text-slate-300 text-sm mb-4 block">Car engine oil</span>
                            <a href="#"
                        ...
                        <div class="bg-slate-50 dark:bg-slate-900 p-4 rounded text-center">
                            ...
                            <span class="text-slate-500 dark:text-slate-300 text-sm mb-1 block font-normal">$150.00
                            </span>
